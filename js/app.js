...
if (iconMenu != null) {
	let delay = 500;
	let menuBody = document.querySelector(".bottom-header");
...
function sliders_bild_callback(params) { }
if (document.querySelectorAll('.mainslider')) {
...
let menuCategoriesHeader = document.querySelector('.categories__header');
let menuCategoriesBurger = document.querySelector('.categories__burger');
let menuCategoriesBody = document.querySelector('.categories__body');
menuCategoriesHeader.addEventListener("click", function(e){
	menuCategoriesBurger.classList.toggle('_active');
	_slideToggle(menuCategoriesBody);
});